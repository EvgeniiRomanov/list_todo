...
class ModelAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'nt_title', 'nt_importance', 'nt_public', 'nt_endtime')

    # отвечает за отображение полей. Группировака поля в режиме редактирования
    fields = (('nt_title', 'nt_public', 'nt_importance'), 'nt_description', 'nt_createtime', 'nt_updatetime', 'nt_endtime', 'nt_author')
