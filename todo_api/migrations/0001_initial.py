# Generated by Django 4.0.4 on 2022-05-31 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nt_status', models.IntegerField(choices=[(2, 'Активно'), (1, 'Отложено'), (0, 'Выполено')], default=2, verbose_name='Статус задачи')),
                ...
                ('nt_endtime', models.DateTimeField(default=datetime.datetime(2022, 6, 1, 11, 13, 4, 730050), verbose_name='Выполнить к:')),
                ('nt_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
